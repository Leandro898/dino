@php
    ...
    $supportWhatsAppNumber = preg_replace('/\D+/', '', (string) (config('services.support.whatsapp_number') ?: config('services.bank_transfer.whatsapp_number')));
