    ...
    <main class="max-w-7xl mx-auto px-6 py-10 lg:py-20">
        <div class="flex flex-col lg:flex-row gap-20">
            ...
            <div class="w-full lg:w-2/5 flex flex-col">
                ...
                <div
                    class="mt-10 pt-6 border-t border-gray-100 dark:border-white/5 flex items-center justify-between text-gray-400">
                    ...
                    <div class="text-right flex flex-col">
                        ...
                        <span
                            class="text-xs font-bold text-gray-600 dark:text-gray-300">{{ $product->created_at->diffForHumans() }}</span>
                    </div>
                </div>
            </div>
