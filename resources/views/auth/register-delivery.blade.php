<x-guest-layout>
    <div class="mb-4 text-center">
        <h2 class="text-2xl font-bold text-gray-900">Únete como Repartidor</h2>
        <p class="text-sm text-gray-600 mt-2">Crea tu cuenta para empezar a entregar pedidos y usar la App de Repartidores.</p>
    </div>
    ...
    <form method="POST" action="{{ route('register.delivery') }}">
        ...
        <div class="mt-4" x-data="{ show: false }">
            ...
            <div class="relative">
                ...
                <button type="button" class="absolute inset-y-0 right-0 pr-3 flex items-center" @click="show = !show">
                    ...
                    <!-- Eye off icon -->
                    <svg x-show="show" class="h-5 w-5 text-gray-500 hover:text-gray-700" style="display: none;" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="flex items-center justify-end mt-6">
            ...
            <x-primary-button class="ms-4 bg-green-600 hover:bg-green-700">
                {{ __('Registrarme como Repartidor') }}
            </x-primary-button>
        </div>
    </form>
</x-guest-layout>
