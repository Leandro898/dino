...
<body class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] antialiased">
    ...
    <header class="w-full p-6 lg:px-20 flex justify-between items-center bg-white dark:bg-[#161615] shadow-sm sticky top-0 z-50">
        <span class="text-2xl font-bold text-[#f53003]">Marketplace Bariloche</span>
    </header>
    ...
    <main class="max-w-3xl mx-auto px-6 py-10 lg:py-20 text-center">
        <div class="bg-white dark:bg-[#161615] p-10 rounded-3xl shadow-sm border border-gray-100 dark:border-[#2a2a2a]">
            ...
            <div class="bg-[#f9f9f9] dark:bg-[#0f0f0f] p-4 rounded-2xl mb-8 flex justify-between items-center">
                ...
                <span class="text-2xl font-bold text-[#f53003]">${{ number_format($order->total, 0, ',', '.') }}</span>
            </div>

            <div id="wallet_container"></div>

            <div class="mt-8 pt-6 border-t dark:border-[#2a2a2a]">
                <a href="{{ route('home') }}" class="text-sm font-bold uppercase tracking-widest text-gray-400 hover:text-black transition-colors">
