    ...
    <main class="category-mobile-scroll-safe max-w-7xl mx-auto px-4 py-8 md:px-10 lg:px-20 md:py-10">
        <section
            ...
            <form id="search-form" method="GET"
                ...
                <div class="flex">
                    @php
                        $placeholderEj = 'leche, arroz...';
                        if ($categorySlug === 'farmacia') {
                            $placeholderEj = 'alikal, buscapina, etc...';
                        } elseif ($categorySlug === 'almacen') {
                            $placeholderEj = 'pan, arroz, etc...';
                        } elseif ($categorySlug === 'bebidas') {
                            $placeholderEj = 'gaseosa, jugo, fernet, etc...';
                        }
                    @endphp
                    <input id="supermarket-search" type="text" name="q" value="{{ $search }}"
                        placeholder="¿Qué necesitás hoy? Ej: {{ $placeholderEj }}" autocomplete="off"
        ...
        <section class="mt-8" id="products-section">
            <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; margin-bottom: 2rem;">
                <button type="button" onclick="startVoiceSearch('supermarket-search', 'search-form')" class="shared-mic-btn" style="margin-bottom: 12px;" title="Búsqueda por voz">
        ...
        function startVoiceSearch(inputId, formId) {
            ...
            recognition.onresult = function(event) {
                ...
                if(formElement) {
                    ...
                    // Si no hay formId, asume que apretar Enter en el input hace submit
            ...
            recognition.onend = function() {
                if(!inputElement.value) {
                    inputElement.placeholder = '¿Qué necesitás hoy?';
                }
            };
