...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'Marketplace Local') }}</title>
...
@endphp
    ...
    <section class="relative w-full h-[400px] bg-gradient-to-r from-orange-600 to-red-700 flex items-center overflow-hidden">
        ...
        <div class="relative max-w-7xl mx-auto px-6 lg:px-20 w-full text-white">
            <h2 class="text-4xl md:text-6xl font-extrabold mb-4 drop-shadow-md">Todo lo que buscas,<br>en tu ciudad.</h2>
            <p class="text-lg md:text-xl opacity-90 max-w-lg mb-8">Comprá y vendé de forma local en Bariloche de manera fácil y rápida.</p>
            <div class="flex gap-4">
                <a href="#productos" class="bg-white text-[#f53003] px-6 py-3 rounded-full font-bold hover:bg-gray-100 transition-all shadow-lg">Ver productos</a>
            </div>
        </div>
    </section>
    ...
    @forelse($products as $product)
        <a href="{{ route('products.show', $product->id) }}" class="group bg-white dark:bg-[#1d1d1d] rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all flex flex-col h-full border border-gray-100 dark:border-white/5">
            ...
            <div class="relative aspect-[3/4] overflow-hidden bg-gray-200">
                ...
                <div class="absolute bottom-4 left-4 bg-white dark:bg-black p-2 rounded-lg text-center min-w-[50px] shadow-md">
            ...
            <div class="p-4 flex flex-col flex-grow">
                ...
                <h3 class="text-sm font-extrabold dark:text-white uppercase leading-tight mb-2 line-clamp-2 group-hover:text-[#f53003] transition-colors">
                    {{ $product->name }}
                </h3>
