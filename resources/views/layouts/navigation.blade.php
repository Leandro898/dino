...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <a href="{{ route('cart.index') }}" class="relative">
        <svg xmlns="http://www.w3.org/2000/svg"
             class="w-6 h-6 text-gray-600 hover:text-red-500 transition-colors"
             fill="none"
             viewBox="0 0 24 24"
             stroke="currentColor">
            <path stroke-linecap="round"
                  ...
                  stroke-width="2"
                  d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-1.35 6.75A1 1 0 007.63 21h8.74a1 1 0 00.98-.75L17 13M9 21a1 1 0 100-2 1 1 0 000 2zm8 0a1 1 0 100-2 1 1 0 000 2z" />
        </svg>
    ...
    @else
        ...
        <a href="{{ route('register') }}" class="text-sm text-gray-600 hover:text-gray-900 transition">
            Registrarse
        </a>
    @endauth
